...
class Contract_base:
    ...
    @decore.widget(parent_id='per_vi1_di1_wi1', title='Contracts', icon='mdi-certificate', type='table', fields=[Model.position, Model.start_date, Model.end_date, Model.fixed_term])
